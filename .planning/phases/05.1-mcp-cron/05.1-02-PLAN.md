...
<success_criteria>
- Claude calls mcp__klausbot__create_cron (not klausbot cron add)
- Claude calls mcp__klausbot__list_crons (not klausbot cron list)
- Claude calls mcp__klausbot__delete_cron (not klausbot cron delete)
