...
decisions:
  - "Separate build entry point for MCP server (dist/mcp-server/index.js)"
...
### Build Configuration
- Added `src/mcp-server/index.ts` to tsup entry array
- Outputs to `dist/mcp-server/index.js`
